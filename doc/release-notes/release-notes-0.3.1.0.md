dougcoin version 0.3.1.0 is now available from:
...
- `6a3e798` dougcoin-Qt (Windows only): enable DEP for dougcoin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-dougcoin protocol versions
