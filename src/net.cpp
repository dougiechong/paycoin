...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "dougcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are dougcoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.dougcoin.com", "dnsseed.dougcoin.com"},
    {"dnsseed.dougcoinfoundation.org", "dnsseed.dougcoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.dougcoin.com", "tseed.dougcoin.com"},
    {"testnet-seed.dougcoin.mitchellcash.com", "testnet-seed.dougcoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for dougcoin, dougcoinfoundation, xpydev
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. dougcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // dougcoin: mint proof-of-stake blocks in the background
