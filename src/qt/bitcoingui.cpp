 ...
 * The dougcoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("dougcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/dougcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a dougcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/dougcoin"), tr("&About dougcoin"), this);
    aboutAction->setToolTip(tr("Show information about dougcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for dougcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/dougcoin"), tr("Show/Hide &dougcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the dougcoin window"));
    ...
    editConfigAction->setToolTip(tr("Edit the dougcoin.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/dougcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/dougcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("dougcoin client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide dougcoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to dougcoin network", "", count));
}
